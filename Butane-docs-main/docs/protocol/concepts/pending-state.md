...
- [Butane SDK Mempool](https://github.com/BUTANE-Smart-Chain)
...
first-in-first-out (FIFO) fashion. Transactions on Butane cannot be ordered or cherry picked out from the Tendermint node
[mempool](https://docs.tendermint.com/v0.34/tendermint-core/mempool.html).

## Pending State Queries

Butane will make queries which will account for any unconfirmed transactions present in a node's
